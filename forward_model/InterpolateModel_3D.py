...
def InterpModel_3D(Teff, Logg, PGS, modelset='aces-pso318', instrument='OSIRIS', band='Kbb'):
    ...
    if modelset == 'aces-pso318':
        ...
        raise ValueError('Only aces-pso318 modelset available for 3D interpolation')
    ...
    if (Teff, Logg, PGS) in zip(T1['Temp'], T1['Logg'], T1['pgs']): 
        ...
        flux2  = GetModel(T1['Temp'][index0], T1['Logg'][index0], T1['pgs'][index0] )
        waves2 = GetModel(T1['Temp'][index0], T1['Logg'][index0], T1['pgs'][index0], wave=True)
        return waves2, flux2
    ...
    #print(x0, y0, list(set(T1['pgs'][np.where( ( (T1['Temp'] == x0) & (T1['Logg'] == y0) ) & (T1['pgs'] >= PGS))])))
    #print(x1, y1, list(set(T1['pgs'][np.where( ( (T1['Temp'] == x1) & (T1['Logg'] == y1) ) & (T1['pgs'] >= PGS))])))
    z0 = list(set(T1['pgs'][np.where( ( (T1['Temp'] == x0) & (T1['Logg'] == y0) ) & (T1['pgs'] <= PGS) )]) & set(T1['pgs'][np.where( ( (T1['Temp'] == x1) & (T1['Logg'] == y1) & (T1['pgs'] <= PGS)) )]))[-1]
    z1 = list(set(T1['pgs'][np.where( ( (T1['Temp'] == x0) & (T1['Logg'] == y0) ) & (T1['pgs'] >= PGS) )]) & set(T1['pgs'][np.where( ( (T1['Temp'] == x1) & (T1['Logg'] == y1) & (T1['pgs'] >= PGS)) )]))[0]
    #print(z0, PGS, z1)
...
def InterpModel_Log3D(LogTeff, Logg, LogPGS, modelset='aces-pso318', instrument='OSIRIS', band='Kbb'):
    ...
    if modelset == 'aces-pso318':
        ...
        # Check if the model already exists (grid point)
        if (LogTeff, Logg, LogPGS) in zip(T1['Temp'], T1['Logg'], T1['pgs']): 
        ...
        #print(x0, y0, list(set(T1['pgs'][np.where( ( (T1['Temp'] == x0) & (T1['Logg'] == y0) ) & (T1['pgs'] >= PGS))])))
        #print(x1, y1, list(set(T1['pgs'][np.where( ( (T1['Temp'] == x1) & (T1['Logg'] == y1) ) & (T1['pgs'] >= PGS))])))
        z0 = list(set(T1['pgs'][np.where( ( (T1['Temp'] == x0) & (T1['Logg'] == y0) ) & (T1['pgs'] <= 10**LogPGS) )]) & set(T1['pgs'][np.where( ( (T1['Temp'] == x1) & (T1['Logg'] == y1) & (T1['pgs'] <= 10**LogPGS)) )]))[-1]
        z1 = list(set(T1['pgs'][np.where( ( (T1['Temp'] == x0) & (T1['Logg'] == y0) ) & (T1['pgs'] >= 10**LogPGS) )]) & set(T1['pgs'][np.where( ( (T1['Temp'] == x1) & (T1['Logg'] == y1) & (T1['pgs'] >= 10**LogPGS)) )]))[0]
        #print('PGS:', z0, PGS, z1)
        ...
        # Check if the model already exists (grid point)
        if (LogTeff, Logg, LogPGS) in zip(T1['Temp'], T1['Logg'], T1['Metal']): 
            index0 = np.where( (T1['Temp'] == 10**LogTeff) & (T1['Logg'] == Logg) & (T1['Metal'] == LogPGS) )
            flux2  = GetModel(T1['Temp'][index0], T1['Logg'][index0], T1['Metal'][index0] )
            waves2 = GetModel(T1['Temp'][index0], T1['Logg'][index0], T1['Metal'][index0], wave=True)
        ...
        #print(x0, y0, list(set(T1['pgs'][np.where( ( (T1['Temp'] == x0) & (T1['Logg'] == y0) ) & (T1['pgs'] >= PGS))])))
        #print(x1, y1, list(set(T1['pgs'][np.where( ( (T1['Temp'] == x1) & (T1['Logg'] == y1) ) & (T1['pgs'] >= PGS))])))
        z0 = list(set(T1['Metal'][np.where( ( (T1['Temp'] == x0) & (T1['Logg'] == y0) ) & (T1['Metal'] <= LogPGS) )]) & set(T1['Metal'][np.where( ( (T1['Temp'] == x1) & (T1['Logg'] == y1) & (T1['Metal'] <= LogPGS)) )]))[-1]
        z1 = list(set(T1['Metal'][np.where( ( (T1['Temp'] == x0) & (T1['Logg'] == y0) ) & (T1['Metal'] >= LogPGS) )]) & set(T1['Metal'][np.where( ( (T1['Temp'] == x1) & (T1['Logg'] == y1) & (T1['Metal'] >= LogPGS)) )]))[0]
